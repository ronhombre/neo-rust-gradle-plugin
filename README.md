...
### Current Status
As of version 0.5.3, Neo Rust Gradle Plugin can build, test, benchmark, publish(?), and run most Rust projects without
...
```kotlin
plugins {
    id("asia.hombre.neorust") version "0.5.3"
}
```
