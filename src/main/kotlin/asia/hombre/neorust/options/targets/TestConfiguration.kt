 ...
 */
abstract class TestConfiguration @Inject constructor(name: String): BinaryConfiguration(name) {
     ...
     *
     * The file will be searched in directory `src/test/rust/` of this Gradle project.
     *
     * So if you do `resolve("example.rs")`, it will be internally resolved as `src/test/rust/example.rs`. This
